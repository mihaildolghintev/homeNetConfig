...
---CONFIG
------------------------------------------------------------------------
myFont = "xft:PragmataPro Mono Liga:bold:pixelsize=11"
myModMask = mod1Mask  -- Sets modkey to super/windows key
myTerminal = "kitty"      -- Sets default terminal
myTextEditor = "nvim"     -- Sets default text editor
myBorderWidth = 2         -- Sets border width for windows
myWorkspaces =
  ["CODE", "SERVER", "MUSIC", "BROWSER", "IM", "DOCUMENTATION", "7", "8", "9"]

myStartupHook :: X ()
myStartupHook =
  spawnOnce "/home/mishakos/.screenlayout/main.sh"
    <+> spawnOnce "redshift"
    <+> spawnOnce
    ...
    <+> spawnOnce "screen -dmS rtorrent rtorrent"
    <+> spawnOnce "yandex-disk start"
    <+> spawnOnce "emacs --daemon=ins1"
    <+> setWMName "LG3D"
windowCount =
  gets
    $ Just
...
myKeys =
  ...
  , ( "M-C-c"
    , namedScratchpadAction myScratchPads "cmus"
    )
...
grid =
  renamed [Replace "grid"]
    ...
    $ Grid (16 / 10)
threeCol =
  renamed [Replace "threeCol"] $ limitWindows 3 $ ThreeCol 1 (3 / 100) (1 / 2)
threeRow = renamed [Replace "threeRow"] $ limitWindows 3 $ Mirror $ mkToggle
  (single MIRROR)
  zoomRow
oneBig =
